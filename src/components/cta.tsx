      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-10 max-w-xl mx-auto">
            Whether you&apos;re a CEO evaluating your AI strategy, a board assessing technology risk,
            or a PE firm doing due diligence on a portfolio company, we should talk.
          </p>
