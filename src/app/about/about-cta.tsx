      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg text-muted mb-10">
            Whether it&apos;s a technology strategy conversation, an AI
            readiness assessment, or a full organizational transformation — it
            starts with understanding where you are today.
          </p>
