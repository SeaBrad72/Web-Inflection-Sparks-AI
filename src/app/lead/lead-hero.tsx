      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-16 md:py-32 w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            You need a{" "}
            <span className="text-gradient-teal">transformation leader</span>,
            not an 18&#8209;month&nbsp;search.
          </motion.h1>
          ...
          >
            Fractional CTO, CAIO, and CPO leadership for organizations navigating
            AI transformation. We set strategy, align stakeholders, and stay long
            enough to make sure it takes root.
          </motion.p>
